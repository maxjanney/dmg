...
fn exec_cb(ins: u8, regs: &mut Registers, mem: &mut Memory) -> u32 {
    ...
    match ins {
        ...
        0x86 => { xxx_hl!(hl, hl & !(1 << 0)); 16 } // RES 0, (HL)
        ...
        0x8e => { xxx_hl!(hl, hl & !(1 << 1)); 16 } // RES 1, (HL)
        ...
        0x96 => { xxx_hl!(hl, hl & !(1 << 2)); 16 } // RES 2, (HL)
        ...
        0x9e => { xxx_hl!(hl, hl & !(1 << 3)); 16 } // RES 3, (HL)
        ...
        0xa6 => { xxx_hl!(hl, hl & !(1 << 4)); 16 } // RES 4, (HL)
        ...
        0xae => { xxx_hl!(hl, hl & !(1 << 5)); 16 } // RES 5, (HL)
        ...
        0xb6 => { xxx_hl!(hl, hl & !(1 << 6)); 16 } // RES 6, (HL)
        ...
        0xbe => { xxx_hl!(hl, hl & !(1 << 7)); 16 } // RES 7 (HL)
        ...
        0xc6 => { xxx_hl!(hl, hl | (1 << 0)); 16 }  // SET 0, (HL)
        ...
        0xce => { xxx_hl!(hl, hl | (1 << 1)); 16 }  // SET 1, (HL)
        ...
        0xd6 => { xxx_hl!(hl, hl | (1 << 2)); 16 }  // SET 2 (HL)
        ...
        0xde => { xxx_hl!(hl, hl | (1 << 3)); 16 }  // SET 3, (HL)
        ...
        0xe6 => { xxx_hl!(hl, hl | (1 << 4)); 16 }  // SET 4, (HL)  
        ...
        0xee => { xxx_hl!(hl, hl | (1 << 5)); 16 }  // SET 5, (HL)
        ...
        0xf6 => { xxx_hl!(hl, hl | (1 << 6)); 16 }  // SET 6, (HL)
        ...
        0xfe => { xxx_hl!(hl, hl | (1 << 7)); 16 }  // SET 7, (HL)
